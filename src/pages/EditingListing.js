...
import {updateDoc, getDoc, addDoc, collection,doc, serverTimestamp } from 'firebase/firestore'
...
const EditListings = () => {
    ...
    //add out auth user  uid to our listing data
    useEffect(() => {
        if (isMounted) {
    ...
    useEffect(() => {
        ...
        const fetchListing = async() => {
            ...
            if(querySnapshot.exists()){
                ...
                setFormData({...querySnapshot.date() , address: querySnapshot.data().location})
                setIsLoading(false)
                toast.success('listing fetched successfully')
            }else{

                toast.error('cannot fetch listing to edit')
                navigate('/')
            }
        }
    ...
    //check the listing and redirect the user if the listing is not theirs
    useEffect(() => {
    ...
    }, [listing.userRef, auth.currentUser.uid , navigate , listing ])
        ...
        <div className="profile">
            ...
            <main>
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="primaryButton EditListingsButton" type='submit'>
                   Update Listing
                    </button>
                </form>
            </main>
